...
void TaskScene::Create()
{
    ...
    Drawable *gestell = m_factory->GenRectangle(QVector3D(300,100,60),QVector4D(0.5,0.5,0.5,1.0), ds);


    // Klotz 50x50
    Drawable *klotz = m_factory->GenRectangle(QVector3D(50,50,50),QVector4D(0.8,0.5,0.5,1.0), ds);
    ...
    // Schlitten 80x40
    Drawable *schlitten = m_factory->GenRectangle(QVector3D(80,40,40),QVector4D(0.8,0.8,0.5,1.0), ds);
    ...
    Drawable *vsp = m_factory->GenRectangle(QVector3D(1,1,150),QVector4D(0.0,0.8,0.5,1.0), ds);
    ...
    // Punkt
    Drawable *punkt = m_factory->GenRectangle(QVector3D(4,4,4),QVector4D(0.5,0.8,0.8,1.0), ds);
    ...
    // H-Linie
    Drawable *hl = m_factory->GenRectangle(QVector3D(120,1,1),QVector4D(0.0,0.8,0.5,1.0), ds);
    ...
    // Block1
    Drawable *block1 = m_factory->GenRectangle(QVector3D(30,30,30),QVector4D(0.8,0.5,0.8,1.0), ds);
    ...
    // Block2
    Drawable *block2 = m_factory->GenRectangle(QVector3D(30,30,30),QVector4D(0.8,0.5,0.8,1.0), ds);
