...
void TaskScene::Create()
{
    ...
    m_gestell = m_factory->GenBlock(QVector3D(300,100,60),QVector4D(0.0,0.75,1.0,1.0), ds);


    // Klotz 50x50
    m_klotz = m_factory->GenBlock(QVector3D(50,50,50),QVector4D(1.0,0.25,0.0,1.0), ds);
    ...
    // Schlitten 80x40
    m_schlitten = m_factory->GenBlock(QVector3D(80,40,40),QVector4D(0.25,1.0,0.0,1.0), ds);
    ...
    m_vsp = m_factory->GenBlock(QVector3D(1,1,150),QVector4D(1.0,0.75,0.0,1.0), ds);
    ...
    // Punkt
    m_punkt = m_factory->GenBlock(QVector3D(4,4,4),QVector4D(1.0,0.75,0.0,1.0), ds);
    ...
    // H-Linie
    m_hl = m_factory->GenBlock(QVector3D(120,1,1),QVector4D(1.0,0.75,0.0,1.0), ds);
    ...
    // Block1
    m_block1 = m_factory->GenBlock(QVector3D(30,30,30),QVector4D(1.0,0.0,0.25,1.0), ds);
    ...
    // Block2
    m_block2 = m_factory->GenBlock(QVector3D(30,30,30),QVector4D(1.0,0.0,0.25,1.0), ds);
